                        ...
                        <div class="row" >
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h2 class="mb-sm-0 font-size-18">جدول الأساتذة</h2>
                                    <div class="col-sm-6">
                                        <h2 dir="rtl">
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-sm-8">
                                                <div >
                                                    ...
                                                    <button type="button" class="btn btn-success btn-rounded waves-effect waves-light mb-2 me-2" id="btn-new-event" style="font-size:15px" ><i class="mdi mdi-plus me-1"></i> إضــافة أستاذ </button>
                                            ...
                                            <table class="table align-middle table-nowrap table-check">
                                                <thead class="table-light">
                                                    <tr >
                                                        ...
                                                        <th class="text-center">اسم الأستاذ</th>
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" placeholder="الرجاءإدخال اسم الأستاذ "
                                                    type="text" name="title" id="event-title" required oninvalid="this.setCustomValidity('الرجاء ادخال اسم المندوب   ')" oninput="this.setCustomValidity('')" autocomplete="name" autofocus />
                                        ...
                                        <div class="col-6">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" placeholder="الرجاء إدخال الصفة  "
                                                    type="email" name="title" id="event-title" required oninvalid="this.setCustomValidity('الرجاء ادخال الإيميل    ')" oninput="this.setCustomValidity('')" autocomplete="name" autofocus />
                                                <div class="invalid-feedback"> </div>
                                            </div>
                                        </div>
